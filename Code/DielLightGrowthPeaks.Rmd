...
MuTime <- as_tsibble(DielFilter, index = time, key = c(Tube, ExpDate, MC, PrimaryOperator, SampleID, Run, Strain, ExpStartTime, Par_ue, Photoperiod, Temp_c, O2, O2_Category, WL, LightShape))
