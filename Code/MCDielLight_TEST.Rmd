...
```{r data files}
MCFilesSySl <- list.files(path = file.path("..", "Data", "ImportedData", "ImportedMCData","SySl"), full.names = TRUE)
MCFilesSySl

MCFilesMiSa <- list.files(path = file.path("..", "Data", "ImportedData", "ImportedMCData","MiSa"), full.names = TRUE)
MCFilesMiSa
```
