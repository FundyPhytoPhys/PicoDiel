...
- Folder ProcessedMCDielLightData contains PicoDiel_Processed_MCDielLightData.Rds generated from MCDielLight.Rmd (stored in Code folder).

- Folder ProcessedPigmentsData contains PicoDiel_Processed_PigmentsAll.Rds generated from Process_PigmentsData.Rmd (stored in Code folder in BalticPhotoperiod repository).

- Folder ProcessedSolisenseData contains PicoDiel_Processed_SolisenseJVPSII.Rds generated from Process_GrowthRateSolisenseLRCData.Rmd (stored in Code folder).
...
RawData folder contains: MCData.zip, SolisenseNSData.zip, and SolisenseOSData.zip.
...
Docs folder contains INSTRUCTIONS.md.

### Manuscript

Manuscript folder contains the files needed to generate the manuscript.
...
https://docs.google.com/spreadsheets/d/1OdKO1rllm3Oo2fNOG1xY5CDoa-ggCYpgMRaSn5gghjo/edit#gid=0

### Manuscript

- URL for main Manuscript:
https://docs.google.com/document/d/1oz-ouRj_OsACiPt0ajHnmGClXCqI5K09JLEgJf8bPC0/edit
